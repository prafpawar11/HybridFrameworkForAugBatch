...
public class ContactPageTest extends baseClass{
	...
	public void setUp() {
		...
		logger=Logger.getLogger(ContactPageTest.class);
	...
	public void validateLoginFunctionality() {
		System.out.println();
		logger.info("**************** Validate the login functionality ******************************");
		System.out.println();
	...
	public void validateLoggedUserName() throws InterruptedException {
		System.out.println();
		logger.info("**************** Validate the logged user name functionality ******************************");
		System.out.println();
	...
	public void validateContactLink() {
		logger.info("**************** Validate the contact link functionality ******************************");
